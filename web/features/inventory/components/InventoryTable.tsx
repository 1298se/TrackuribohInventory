...
import { SKUDisplay } from "@/features/inventorySearch/components/SkuDisplay";
...
export function InventoryTable({
  ...
  const [selectedProduct, setSelectedProduct] =
    useState<ProductWithSetAndSKUsResponse | null>(null);
      ...
      <CardHeader className="bg-linear-to-r from-slate-50 to-gray-50 dark:from-slate-900 dark:to-gray-900">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
          ...
          <div className="flex items-center gap-3">
            ...
            />
            <SelectProductDialog onSelect={handleProductSelect} />
          </div>
        </div>
      </CardHeader>
