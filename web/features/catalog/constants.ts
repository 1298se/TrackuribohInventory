...
export const SET_NAME_TO_ID: Record<string, string> = {
  // Mega Evolution
  "Mega Evolution": "06879ff4-9d41-746d-8000-0196dd8358b5",

  // Scarlet & Violet Era
  "Scarlet & Violet Base Set": "067820d9-ab4f-7744-8000-e423d2e2ae7e",
  "Paldea Evolved": "067820d9-a961-7a3f-8000-c4fd4aec32c7",
  "Obsidian Flames": "067820d9-a879-72d1-8000-3f97ce09441b",
  "Paradox Rift": "067820d9-a3df-717b-8000-aa8553e98fdf",
  "Temporal Forces": "067820d9-a103-7211-8000-906bae167f1e",
  "Twilight Masquerade": "067820d9-a01b-7dd7-8000-bb56fa81f94f",
  "Stellar Crown": "067820d9-9c81-74e7-8000-1aa6c5798f84",
  "Surging Sparks": "067820d9-9b97-7abb-8000-9094ef6f6a2f",
  "Journey Together": "06786ed6-d75d-7f47-8000-187dbeab905e",
  "Destined Rivals": "067e8e23-b888-7872-8000-2410f28eb2d8",
  "Black Bolt": "068302bb-4376-7af1-8000-df8dfec8bbff",
  "White Flare": "068302bb-43d9-745a-8000-614780ab883d",
  "Paldean Fates": "067820d9-a1f0-76c4-8000-67041e757d70",
  "Prismatic Evolutions": "067820d9-9ab8-7077-8000-eb86a13fee5d",
  "Scarlet & Violet 151": "067820d9-a5b7-7bf1-8000-bd857e433f2c",
  "Scarlet & Violet Promo Cards": "067820d9-aa51-7b82-8000-3badb49ebf56",
  "Shrouded Fable": "067820d9-9e43-7dab-8000-260f709f8021",
  "Scarlet & Violet Energies": "0688096c-5d2a-739d-8000-9bce63a42b79",
};

export type SetName = keyof typeof SET_NAME_TO_ID;

export const SET_ERA_MAP: Record<string, string> = {
